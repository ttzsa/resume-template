...
function SortableBlock({ block, depth, onChange, onRemove }: { block: ContentBlock; depth: number; onChange: (block: ContentBlock) => void; onRemove: () => void }) {
  ...
  return <div ref={sortable.setNodeRef} style={{ transform: CSS.Transform.toString(sortable.transform), transition: sortable.transition }} className="content-block-card" data-editor-block-id={block.id}>
