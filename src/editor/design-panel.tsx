  ...
  return (
    <div className="editor-scroll design-panel">
      ...
      <details className="design-group"><summary>列表与链接</summary><div className="design-grid">
        ...
        <NumberField label="列表项间距" unit="mm" value={theme.bullet.itemGap} onChange={(value) => updateTheme({ bullet: { ...theme.bullet, itemGap: value } })} />
